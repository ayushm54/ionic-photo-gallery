...
let PhotoService = class PhotoService {
    ...
    addNewToGallery() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            // Take a photo
            const capturedPhoto = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Camera.getPhoto({
            ...
            _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Storage.set({
    ...
    loadSaved() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const photos = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Storage.get({ key: this.PHOTO_STORAGE });
            this.photos = JSON.parse(photos.value) || [];
            if (!this.platform.is('hybrid')) {
                // Display the photo by reading into base64 format
                for (const photo of this.photos) {
                    // Read each saved photo's data from the Filesystem
                    const readFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Filesystem.readFile({
                        path: photo.filepath,
    ...
    savePicture(cameraPhoto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const savedFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Filesystem.writeFile({
                path: fileName,
                data: base64Data,
                directory: _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["FilesystemDirectory"].Data
            });
    ...
    readAsBase64(cameraPhoto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.platform.is('hybrid')) {
                ...
                const file = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Filesystem.readFile({
